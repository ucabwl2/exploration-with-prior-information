...
void AASS::vodigrex::LineFollower::lineThinningAlgo()
{
...
void AASS::vodigrex::LineFollower::init()
{
...
void AASS::vodigrex::LineFollower::getNewBranch()
{
...
void AASS::vodigrex::LineFollower::removeLineSegment(cv::Mat& c)
{
	//Make the whole mat black
	c.setTo(cv::Scalar(0));
}

void AASS::vodigrex::LineFollower::drawLine()
{
...
void AASS::vodigrex::LineFollower::upResize(bool north, bool est, bool south, bool west)
{
...
*/
bool AASS::vodigrex::LineFollower::findNextLPRP(std::vector< cv::Point2i >& all_points)
{
...
void AASS::vodigrex::LineFollower::addPoint2Explore(const std::vector< cv::Point2i >& all_points)
{
	if(all_points.size() >= 2){
...
double AASS::vodigrex::LineFollower::calculateDistance(std::vector< cv::Point2i >& all_points)
{
...
void AASS::vodigrex::LineFollower::moveForward()
{
	moveForward(true);
}

void AASS::vodigrex::LineFollower::moveForward(bool erase_W)
{
	drawLine();
	if(erase_W == true){
...
bool AASS::vodigrex::LineFollower::testNewBranchNotBlackandMoveForward()
{
	drawLine();
	removeLineSegment(_W);
...
int AASS::vodigrex::LineFollower::typeOfIntersection(cv::Mat& roi)
{
...
void AASS::vodigrex::LineFollower::clear()
{
